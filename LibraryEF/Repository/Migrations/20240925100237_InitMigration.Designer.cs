...
namespace Repository.Migrations
{
    ...
    [Migration("20240925100237_InitMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Repository.DocType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Repository.Librarian", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Repository.PublishingType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Repository.Reader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Repository.Book", b =>
                {
                    ...
                    b.HasOne("Repository.PublishingType", "PublishingType")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Repository.Reader", b =>
                {
                    b.HasOne("Repository.DocType", "DocType")
                        .WithMany("Readers")
